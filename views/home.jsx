...
const {
  Container, Grid, Card, Form, Button, Text
} = require('tabler-react')
const NoHeader = require('./layouts/Noheader')
...
module.exports = () => (
  <NoHeader>
    <Container>
      ...
      <Grid.Row alignItems="center" className="fullHeight py-4">
        <Grid.Col className="mx-auto col-login">
          ...
          <Text align="center">
            Want to run Dependencies App on your own? <a href="/installations/new">find out how</a>
          </Text>
        </Grid.Col>
      </Grid.Row>
    </Container>
